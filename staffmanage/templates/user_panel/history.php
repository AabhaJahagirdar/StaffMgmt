							...
							<!-- <div class="container-fluid mt-2 p-5"> -->
								...
								<div class="cart">
									...
									<div class="products">
										 ...
										 <div class="product">
											<img src="..\..\asset\img_user\p-6.jpg" alt="" class="img-fluid">
											<div class="product-info">
												<h3 class="product-name"> Egypt</h3>
												<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, nam!</p>
												<h2 class="product-price">$90.00</h2>
												 <!-- <div class="quantity">
														   <span class="dec">-</span>
										 ...
										 <div class="product">
											<img src="..\..\asset\img_user\p-1.jpg" alt="" class="img-fluid">
											<div class="product-info">
										...
										<div class="product">
											<img src="..\..\asset\img_user\p-5.jpg" alt="" class="img-fluid">
											<div class="product-info">
												<h3 class="product-name"> Tokyo</h3>
												<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, nam!</p>
												<h2 class="product-price">$90.00</h2>
												 <!-- <div class="quantity">
															<span class="dec">-</span>
