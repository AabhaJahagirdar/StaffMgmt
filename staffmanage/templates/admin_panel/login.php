              ...
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="AddCategory.php">
							<i class="fa fa-history fa-lg" aria-hidden="true"></i> <span class="align-middle">Add Package Catrgory</span>
            </a>
					</li>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="AddElement.php">
							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
							  ...
							  </svg> <span class="align-middle">Add Element</span>
            </a>
					</li>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="EditViewMore.php">
							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bell-fill" viewBox="0 0 16 16">
							  ...
							  </svg> <span class="align-middle">Edit View More Page</span>
            </a>
					</li>
